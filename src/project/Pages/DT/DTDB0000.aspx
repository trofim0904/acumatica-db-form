...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="Workspace" Width="100%" AllowAutoHide="false">
        <Template>
	        ...
	        <px:PXTextEdit Wrap="False" Height="400" Width="1400" TextMode="MultiLine" runat="server" ID="CstPXTextEdit1" DataField="Input" ></px:PXTextEdit>
	        <px:PXTextEdit Wrap="False" Height="400" Width="1400" TextMode="MultiLine" runat="server" ID="CstPXTextEdit2" DataField="Output" ></px:PXTextEdit></Template>
